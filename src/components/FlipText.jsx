...
export function FlipText({
    ...
    return (
        ...
        >
            <style>{`
                @keyframes ft-flip-char {
                    0% {
                        transform: rotateX(-90deg) translateY(20px) translateZ(50px);
                        opacity: 0;
                        filter: blur(8px);
                    }
                    100% {
                ...
                .flip-char {
                    animation: ft-flip-char var(--flip-duration) cubic-bezier(0.34, 1.56, 0.64, 1) var(--flip-delay) var(--flip-iteration) both;
